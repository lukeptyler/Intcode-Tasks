{-# LANGUAGE RankNTypes #-}
module Task09.Intcode.Integration where
...
import Task09.Intcode.Types      (Integration, IntegrationT, IntegrationIO, State(..), Intcode(_state))
import Task09.Intcode.Program    (runUntilStop)
import Task09.Intcode.Accessors  (pushInput, popOutput, isHalted)
