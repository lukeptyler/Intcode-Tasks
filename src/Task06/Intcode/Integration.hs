{-# LANGUAGE RankNTypes #-}
module Task06.Intcode.Integration where
...
import Task06.Intcode.Types      (Integration, IntegrationT, IntegrationIO, State(..), Intcode(_state))
import Task06.Intcode.Program    (runUntilStop)
import Task06.Intcode.Accessors  (pushInput, popOutput, isHalted)
