{-# LANGUAGE RankNTypes #-}
module Task08.Intcode.Integration where
...
import Task08.Intcode.Types      (Integration, IntegrationT, IntegrationIO, State(..), Intcode(_state))
import Task08.Intcode.Program    (runUntilStop)
import Task08.Intcode.Accessors  (pushInput, popOutput, isHalted)
